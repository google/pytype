...
class NamedTupleTestPy3(test_base.BaseTest):
  ...
  def test_basic_namedtuple(self):
    ...
    self.assertTypesMatchPytd(
        ...
        class X(Tuple[int, str]):
          ...
          def __new__(cls: Type[_Tnamedtuple_X_a_b], a: int, b: str) -> _Tnamedtuple_X_a_b: ...
          def _asdict(self) -> collections.OrderedDict[str,
            Union[int, str]]: ...
          @classmethod
          def _make(cls: Type[_Tnamedtuple_X_a_b], iterable: Iterable[Union[int, str]],
            new = ..., len: Callable[[Sized], int] = ...) -> _Tnamedtuple_X_a_b: ...
          def _replace(self: _Tnamedtuple_X_a_b, **kwds: Union[int, str]) -> _Tnamedtuple_X_a_b: ...
          """)
  ...
  def test_baseclass(self):
    ...
    self.assertTypesMatchPytd(
        ...
        _Tnamedtuple_SubNamedTuple_a = TypeVar('_Tnamedtuple_SubNamedTuple_a', bound=SubNamedTuple)
        ...
        class SubNamedTuple(baseClass, Tuple[int]):
            ...
            def __getstate__(self) -> None: ...
            def __init__(self, *args, **kwargs) -> None: ...
            def __new__(cls: Type[_Tnamedtuple_SubNamedTuple_a], a: int) -> _Tnamedtuple_SubNamedTuple_a:
              ...
            def _asdict(self) -> collections.OrderedDict[str, int]: ...
            @classmethod
            def _make(cls: Type[_Tnamedtuple_SubNamedTuple_a],
                      iterable: Iterable[int], new = ...,
                      len: Callable[[Sized], int] = ...) -> _Tnamedtuple_SubNamedTuple_a: ...
  ...
  def test_generated_members(self):
    ...
    self.assertTypesMatchPytd(ty, (
        ...
        class X(Tuple[int, str]):
            ...
            @classmethod
            def _make(
                cls: Type[_Tnamedtuple_X_a_b], iterable: Iterable[Union[int, str]], new = ...,
  ...
  def test_namedtuple_with_defaults(self):
    ...
    self.assertTypesMatchPytd(
        ...
        _Tnamedtuple_SubNamedTuple_a_b_c = TypeVar('_Tnamedtuple_SubNamedTuple_a_b_c', bound=SubNamedTuple)
        ...
        class SubNamedTuple(Tuple[int, str, int]):
            ...
            def __getstate__(self) -> None: ...
            def __init__(self, *args, **kwargs) -> None: ...
            def __new__(cls: Type[_Tnamedtuple_SubNamedTuple_a_b_c], a: int, b: str = ...,
              c: int = ...) -> _Tnamedtuple_SubNamedTuple_a_b_c: ...
            def __repr__(self) -> str: ...
            def _asdict(self) -> collections.OrderedDict[str, Union[int, str]]:
              ...
            @classmethod
            def _make(cls: Type[_Tnamedtuple_SubNamedTuple_a_b_c],
                      iterable: Iterable[Union[int, str]], new = ...,
                      len: Callable[[Sized], int] = ...) -> _Tnamedtuple_SubNamedTuple_a_b_c: ...
            def _replace(self: _Tnamedtuple_SubNamedTuple_a_b_c,
                         **kwds: Union[int, str]) -> _Tnamedtuple_SubNamedTuple_a_b_c: ...
            def func() -> None: ...
  ...
  def test_generic_namedtuple(self):
    ...
    self.assertTypesMatchPytd(
        ...
        class Foo(Tuple[T, Callable[[T], T]], Generic[T]):
          ...
          def __getstate__(self) -> None: ...
          def __init__(self, *args, **kwargs) -> None: ...
          def __new__(cls: Type[_Tnamedtuple_Foo_x_y], x: T, y: Callable[[T], T]) -> _Tnamedtuple_Foo_x_y: ...
          def _asdict(
              self
          ) -> collections.OrderedDict[str, Union[Callable[[T], T], T]]: ...
          @classmethod
          def _make(
              cls: Type[_Tnamedtuple_Foo_x_y], iterable: Iterable[Union[Callable[[T], T], T]],
              new = ..., len: Callable[[Sized], int] = ...) -> _Tnamedtuple_Foo_x_y: ...
          def _replace(
              self: _Tnamedtuple_Foo_x_y, **kwds: Union[Callable[[T], T], T]) -> _Tnamedtuple_Foo_x_y: ...
      """)
