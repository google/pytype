  ...
  def test_generic_namedtuple(self):
    ...
    self.assertTypesMatchPytd(
        ...
        class Foo(tuple, Generic[T]):
          ...
          def _asdict(self) -> collections.OrderedDict[str, Union[Callable[[T], T], T]]: ...
          @classmethod
          def _make(cls: Type[_TFoo], iterable: Iterable[Union[Callable[[T], T], T]], new = ..., len: Callable[[Sized], int] = ...) -> _TFoo: ...
          def _replace(self: _TFoo, **kwds: Union[Callable[[T], T], T]) -> _TFoo: ...
      """)
