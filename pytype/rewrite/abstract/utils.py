...
from typing import Any, get_origin, overload, TypeVar
...
def get_atomic_constant(
    var: variables.Variable[base.BaseValue], typ: None = None
):
...
def join_values(
    ctx: base.ContextType, values: Sequence[base.BaseValue]
) -> base.BaseValue:
  if len(values) > 1:
