...
class TestDataFiles(parser_test_base.ParserTest):
  ...
  def test_get_predefined_file_basic(self):
    ...
    self.assertEqual(path, file_utils.replace_seperator(
      "stubs/builtins/builtins.pytd"))
  ...
  def test_pytd_builtin3(self):
    ...
    with open(path_utils.join(path_utils.dirname(file_utils.__file__), "stubs",
  ...
  def test_pytd_builtin_is_package(self):
    ...
    self.assertEqual(path, file_utils.replace_seperator(
      "stubs/builtins/attr/__init__.pytd"))
